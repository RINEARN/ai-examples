...
* takenoko.md - 架空の流行語「たけのこポテンシャル」に関する知識原稿です。
* kinoko.md - 架空の流行語「きのこストリーム」に関する知識原稿です。
* misanswers.md - ハルシネーションを抑えるための誤回答集です。
...
以下は実際の会話例です。（ [こちら](https://chatgpt.com/g/g-giXBqSDlG-q-a-example-ai) で会話できます。）
